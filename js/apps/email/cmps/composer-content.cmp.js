    ...
    template: `
                <section class="composer-content flex column">
                        ...
                        <div class="composer-footer-btns flex space-between">
                            <button class="email-send btn" @click="emitSaveEmailToSent">Send  <i class="fas fa-paper-plane"></i> </button>
                            <button class="email-composer-close-btn btn" @click="emitDeleteCompose"><i class="fas fa-trash"></i></button>
                        </div>
